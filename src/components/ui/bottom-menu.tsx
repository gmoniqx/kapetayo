...
export function MenuBar({ items, className, onItemClick, selectedIndex, ...props }: MenuBarProps) {
        ...
        {items.map((item, index) => (
          <button
            ...
            className={cn(
              ...
              selectedIndex === index ? "bg-primary text-primary-foreground" : "hover:bg-muted/80"
            )}
